            ...
            <Card>
                ...
                <CardContent>
                     <RadioGroup onValueChange={(v) => handleRadioChange('positionType', v)} value={formData.positionType} className="grid md:grid-cols-3 gap-4" required>
                        <div>
                            <RadioGroupItem value="district" id="pos_district" className="peer sr-only" disabled={isPositionDisabled} />
                         ...
                         <div>
                            <RadioGroupItem value="block" id="pos_block" className="peer sr-only" disabled={isPositionDisabled}/>
                ...
                <CardContent className="space-y-4">
                     <div className="grid md:grid-cols-2 gap-6">
                         <div className="grid gap-2">
                             ...
                             <Select onValueChange={(v) => handleLocationSelectChange('state', v)} value={formData.state} required disabled={isDistrictDisabled}>
