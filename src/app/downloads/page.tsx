...
export default function DownloadFormsPage() {
    ...
    const forms = [
        ...
        {
            title: "Kisan Jaivik Card Application Form",
            description: "Application form for the Kisan Jaivik Card scheme.",
            url: "https://github.com/akm12109/assets_vanu/raw/main/forms/Kisan-Jaivik-Card-Application-Form.pdf",
            type: "Application"
        },
        {
